...
public interface CordovaWebViewEngine {
    ...
    void loadUrlContent(String html, boolean clearNavigationStack);
    ...
    boolean goBackOrForward(int index);
    ...
    public static class WebBackForwardListHC {
        ...
        public WebBackForwardListHC(com.tencent.smtt.sdk.WebBackForwardList imp, WebBackForwardList list) {
            webBackForwardListX5 = imp;
            webBackForwardList = list;
        }

        public WebHistoryItemHC getCurrentItem() {
            if (webBackForwardListX5 != null) {
                return new WebHistoryItemHC(webBackForwardListX5.getCurrentItem(), null);
            } else {
                return new WebHistoryItemHC(null, webBackForwardList.getCurrentItem());
            }
        }

        public int getCurrentIndex() {
            if (webBackForwardListX5 != null) {
                return webBackForwardListX5.getCurrentIndex();
            } else {
        ...
        public WebHistoryItemHC getItemAtIndex(int index) {
            if (webBackForwardListX5 != null) {
                return new WebHistoryItemHC(webBackForwardListX5.getItemAtIndex(index), null);
            } else {
                return new WebHistoryItemHC(null, webBackForwardList.getItemAtIndex(index));
            }
        }
        ...
        public int getSize() {
            if (webBackForwardListX5 != null) {
                return webBackForwardListX5.getSize();
            } else {
    ...
    public static class WebHistoryItemHC {
        ...
        public WebHistoryItemHC(com.tencent.smtt.sdk.WebHistoryItem x5item, WebHistoryItem wItem) {
            webHistoryItemX5 = x5item;
            webHistoryItem = wItem;
        }

        public String getUrl() {
            if (webHistoryItemX5 != null) {
                return webHistoryItemX5.getUrl();
            } else {
        ...
        public String getOriginalUrl() {
            if (webHistoryItemX5 != null) {
                return webHistoryItemX5.getOriginalUrl();
            } else {
        ...
        public String getTitle() {
            if (webHistoryItemX5 != null) {
                return webHistoryItemX5.getTitle();
            } else {
