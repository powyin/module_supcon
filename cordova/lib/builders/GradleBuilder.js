...
GradleBuilder.prototype.getArgs = function (cmd, opts) {
    ...
    var hc_build_type = require('cordova-common').hc_build_type;
    if(hc_build_type && ("aar" == hc_build_type)){
        cmd = "hc_build_aar"
    }else{
        cmd = "hc_build_apk"
    }
...
*/
        ...
        /* jshint -W069 */
        var distributionUrl = 'https\\://services.gradle.org/distributions/gradle-4.4-all.zip';
        /* jshint +W069 */
